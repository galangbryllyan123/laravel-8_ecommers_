     ...
     <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">       
        ...
        <div class="container mt-5">
                <div class="section-title-furits text-center">
                    <h2>silahkan kunjungi kategori yang tersedia atau seacrh</h2>
                </div>
                <br>
            <div class="row mt-5">
                ...
                <div class="services-wrapper mt-40">
                    <div class="single-services mb-40">
                        ...
                        <div class="services-content">
                            <h4>Free Shippig</h4>
                            <p>AkpolShop di dukung dengan sistem pengiriman melaui jne,pos,dan secara langsung  </p>
                        </div>
                    </div>
                    <div class="single-services mb-40">
                        <div class="services-img">
                        ...
                        <div class="services-content">
                            <h4>24/7 Support</h4>
                            <p>AkpolShop di dukung dengan Support fitur gmail </p>
                        </div>
                    </div>
                    <div class="single-services mb-40">
                        <div class="services-img">
                        ...
                        <div class="services-content">
                            ...
                            <p>AkpolShop ini di dukung dengan sistem pembayaran secara virtual maupun bayar di tempat</p>
                        </div>
                    </div>
                </div>
            </div>
